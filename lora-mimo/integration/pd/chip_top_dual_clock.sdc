# chip_top dual-clock timing constraints -- P&R SDC.
#
...
#
# SIGNOFF uses chip_top_dual_clock_signoff.sdc instead: this file verbatim
# plus three signoff-only MCP groups (v28 tacc_accumulate / v29 iq_samp_cnt /
# v30 pcfsm_tick_decrement), ported from Trouper's signoff split. Everything
# in this file must stay byte-identical to the head of that one -- if you
# edit here, re-sync there.
