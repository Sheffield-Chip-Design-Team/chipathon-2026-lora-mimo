...
module training_acc_nr2 (
    ...
    output wire signed [63:0] E_ref,
    output wire        training_done, noise_ready,
    ...
    training_acc u (
        ...
        .sf(sf), .ref_sel(ref_sel), .noise_en(noise_en),
        .Z_i0(Z_i0), .Z_q0(Z_q0),
        .Z_i1(Z_i1), .Z_q1(Z_q1),
        .Z_i2(Z_i2_nc), .Z_q2(Z_q2_nc),
        .Z_i3(Z_i3_nc), .Z_q3(Z_q3_nc),
        .E_ref(E_ref), .training_done(training_done),
        .noise_ready(noise_ready), .n_acc(n_acc)
    );
endmodule
EOF
